  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL || 'http://localhost:5000/api'}/receptionist/patients/${searchCardId}`,
        {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_URL || 'http://localhost:5000/api'}/receptionist/patients/update/${patient._id}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-white">
                    ...
                    <p className="text-emerald-100">Card ID: {patient.cardId}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900 font-medium">{patient.bloodGroup}</p>
                    </div>
                  </div>
                </div>
              ...
              {isEditing && (
                <div className="mb-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setEditData({ ...editData, visitReason: e.target.value })}
                    rows="3"
        ...
        {!patient && !loading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">Search for a patient using their Health Card ID</p>
          </div>
        )}
      </div>
    </div>
