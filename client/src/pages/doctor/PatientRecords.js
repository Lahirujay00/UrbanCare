      ...
      records: [
        {
          ...
          notes:
            "Blood pressure well controlled. Patient reports feeling better.",
          doctor: "Dr. Smith",
        },
        {
          id: 2,
      ...
      records: [
        {
          ...
          notes:
            "HbA1c levels improved but still above target. Referred to nutritionist.",
          doctor: "Dr. Smith",
        },
      ],
      vitals: {
      ...
      records: [
        {
          ...
          notes:
            "Patient reports reduced frequency of migraines with new medication.",
          doctor: "Dr. Smith",
        },
      ],
      vitals: {
            ...
            {selectedPatient ? (
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-12 text-center">
                ...
                <p className="text-gray-500">
                  Choose a patient from the list to view their detailed medical
                  records
                </p>
              </div>
            )}
