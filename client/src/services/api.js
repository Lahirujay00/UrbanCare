...
export const authAPI = {
  ...
  receptionistLogin: (credentials) =>
    api.post("/receptionist/auth/login", credentials),
};
...
export const appointmentAPI = {
  ...
  confirmPayment: (id, paymentData) =>
    api.post(`/appointments/${id}/confirm-payment`, paymentData),
  scheduleWithoutPayment: (id) =>
    api.post(`/appointments/${id}/schedule-pay-later`),
  processHospitalPayment: (id, paymentData) =>
    api.post(`/appointments/${id}/hospital-payment`, paymentData),
...
export const medicalRecordsAPI = {
  ...
  uploadDocument: (recordId, formData) =>
    api.post(`/medical-records/${recordId}/document`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    }),
  downloadDocument: (recordId, documentId) =>
    api.get(`/medical-records/${recordId}/document/${documentId}`, {}),
};
...
export const paymentAPI = {
  ...
  getInvoice: (paymentId) =>
    api.get(`/payments/invoice/${paymentId}`, { responseType: "blob" }),
};
...
export const healthCardAPI = {
  ...
  updatePatientCard: (patientId, updateData) =>
    api.put(`/health-cards/patient/${patientId}`, updateData),
  validateCard: (validationData) =>
    api.post("/health-cards/validate", validationData),
  updateCard: (cardId, updateData) =>
    api.put(`/health-cards/${cardId}`, updateData),
...
export const documentAPI = {
  ...
  getPatientDocuments: (patientId, params) =>
    api.get(`/documents/patient/${patientId}`, { params }),
  ...
  shareDocument: (documentId, shareData) =>
    api.post(`/documents/${documentId}/share`, shareData),
...
export const refundAPI = {
  ...
  reviewRefund: (refundId, reviewData) =>
    api.put(`/refunds/${refundId}/review`, reviewData),
  processRefund: (refundId, processData) =>
    api.put(`/refunds/${refundId}/process`, processData),
  cancelRefund: (refundId, cancelData) =>
    api.put(`/refunds/${refundId}/cancel`, cancelData),
...
export const chatbotAPI = {
  ...
  checkEmergency: (messageData) =>
    api.post("/chatbot/emergency-check", messageData),
};
